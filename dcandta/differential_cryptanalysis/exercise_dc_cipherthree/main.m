...
for i=1:no_pairs
    ...
    for key_guess = 0:15
        ...
        z0 = bitxor(key_guess, c0);
        z1 = bitxor(key_guess, c1);
        ...
        delta_y = bitxor(y0, y1);

        % check if delta_y is equal to the highly likely difference 0xc
        % and if so increase the key guess counter
        if delta_y == 12
